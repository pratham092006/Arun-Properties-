...
import { MapPin, Phone, Clock, ExternalLink, Navigation, Building } from 'lucide-react';
import { WhatsappIcon } from './WhatsappIcon';
import { InstagramIcon } from './InstagramIcon';

export const LocationSection: React.FC = () => {
  return (
    <section id="location" className="py-20 bg-gradient-to-b from-[#FAF8F5] via-white to-[#F3EDE6] border-t border-[#EAE3E0] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <p className="mt-3 text-base text-[#4A383A] leading-relaxed">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <motion.div 
            ...
            className="lg:col-span-5 bg-[#1C1617] text-white rounded-3xl p-7 sm:p-9 shadow-2xl flex flex-col justify-between border border-[#3A2D30] relative overflow-hidden"
          >
            <div className="absolute top-0 right-0 w-40 h-40 bg-[#BD2A2A]/10 rounded-full blur-3xl pointer-events-none"></div>
            ...
            <div className="space-y-6 relative z-10">
              ...
              <div className="border-b border-[#3A2D30] pb-5">
                ...
                <h3 className="text-2xl sm:text-3xl font-black text-white tracking-tight">Arun Property Consultancy</h3>
                <p className="text-xs text-[#BCA39A] font-bold mt-1">Est. 2005 • Real Estate & Legal Document Center</p>
              </div>

              {/* Address */}
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-2xl bg-[#4A0E17] border border-[#BD2A2A]/40 flex items-center justify-center shrink-0 shadow-md">
                  <MapPin className="w-5 h-5 text-[#BD2A2A]" />
                </div>
                <div>
                  <h4 className="font-extrabold text-sm text-white">Office Address</h4>
                  <p className="text-xs text-zinc-300 leading-relaxed mt-0.5 font-medium">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="tel:09820607688" className="text-base font-black text-white hover:text-[#BD2A2A] transition-colors block">
                    098206 07688
                  </a>
                  <span className="text-[11px] text-[#BCA39A] font-medium">Direct call for consultation</span>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 pt-2">
                ...
                <div>
                  ...
                  <span className="text-[11px] text-[#BCA39A] font-medium">Follow for property updates & reels</span>
                </div>
              </div>
            ...
            {/* Quick Map Action */}
            <div className="pt-6 border-t border-[#3A2D30] space-y-3 relative z-10">
              <motion.a
              ...
              <motion.a
                ...
                target="_blank"
                rel="noreferrer"
                className="w-full bg-[#25D366] hover:bg-[#20ba5a] text-white font-extrabold py-3 px-4 rounded-xl flex items-center justify-center gap-2 shadow-md transition-all text-xs"
              >
          ...
          <motion.div 
            ...
            className="lg:col-span-7 bg-white rounded-3xl overflow-hidden shadow-2xl border border-[#EAE3E0] min-h-[380px] sm:min-h-[480px] relative"
          >
            <iframe
